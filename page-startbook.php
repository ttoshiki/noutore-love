...
?>
    ...
    <section class="startbook__case">
      ...
      <div class="startbook__caseImageWrapper">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/startbook/case01.jpg" alt="" class="startbook__caseImage -pc">
    ...
    <footer class="startbook__footer">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/startbook/footer.jpg" alt="lets's give it try" class="startbook__footerImage -pc">
